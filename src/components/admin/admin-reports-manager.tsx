    ...
    <>
      <div className="space-y-6">
        {(Object.keys(grouped) as AdminSavedViewScope[]).map((scope) => (
          <div key={scope} className="rounded-[26px] border border-white/[0.12] bg-card/70 backdrop-blur-xl dark:border-white/[0.06] p-5 shadow-sm">
            <div className="mb-4">
            ...
            {grouped[scope].length === 0 ? (
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                {grouped[scope].map((view) => (
                  <div key={view.id} className="rounded-[22px] border border-white/[0.08] bg-white/[0.04] backdrop-blur-sm p-4">
