...
export function AdminActivityTable({ items }: AdminActivityTableProps) {
  ...
  if (items.length === 0) {
    return (
      <div className="rounded-[26px] border border-dashed border-white/[0.08] bg-card/70 px-6 py-12 text-center text-sm text-muted-foreground">
  ...
  return (
    <>
      <div className="rounded-[26px] border border-white/[0.12] bg-card/70 backdrop-blur-xl dark:border-white/[0.06] p-4 shadow-sm">
        <Table>
          <TableHeader>
            <TableRow>
